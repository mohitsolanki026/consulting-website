            ...
            <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Marketing</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Analytics</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Commerce</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Insights</a>
                    </li>
                  </ul>
                </div>
                <div className="mt-10 md:mt-0">
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Pricing</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Documentation</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Guides</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">API Status</a>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">About</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Blog</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Jobs</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Press</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Partners</a>
                    </li>
                  </ul>
                </div>
                <div className="mt-10 md:mt-0">
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Claim</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Privacy</a>
                    </li>
                    <li>
                      <a href="#" className="text-sm leading-6 text-gray-600 hover:text-gray-100">Terms</a>
                    </li>
                  </ul>
                </div>
              </div>
